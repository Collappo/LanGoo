...
const AppContent = () => {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-accent/30">
      ...
      <footer className="flex items-center justify-start py-5 max-w-6xl mx-auto px-4">
        <a href="https://lucide.dev/license" target="_blank"
          className="p-3 bg-surface border border-border rounded-2xl text-text-muted hover:text-text transition-colors shadow-sm flex gap-3"
        >
          ...
          <p className="font-semibold">Lucide License (Icons)</p>
        </a>
      </footer>
    </div>
  );
